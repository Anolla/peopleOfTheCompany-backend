...
let departments=['IT','Engineering','HR','Operations','Customer Support','Marketing','Managment','Finance','Research and Development','Accounting']
...
module.exports ={departmentsRouter,departments} ;
